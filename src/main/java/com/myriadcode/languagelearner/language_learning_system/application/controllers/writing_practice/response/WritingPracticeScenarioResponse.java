...
public record WritingPracticeScenarioResponse(
    ...
    public record WritingStructuredFeedbackResponse(
            String overall, String correctedParagraph, List<TopFix> topFixes, VocabularySummary vocabulary,
            List<SentenceCorrection> sentenceCorrections, List<MicroPracticeItem> microPractice, String nextFocus
    ) {
